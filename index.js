...
class SendMsg {
  ...
  constructor(username, password, routeId, format, messageTemplate) {
    ...
    if (messageTemplate) {
      ...
      this.messageTemplate =
        "Your otp is {{otp}}. For security reasons, DO NOT share this OTP with anyone";
    }
    this.otp_expiry = obj.expireTime;
  }
   ...
   */
  static getBaseURL() {
    if (typeof obj.url === "string" || obj.url instanceof String) {
      return obj.url;
    } else {
      return null;
    }
